...
graph TD
    ...
    I["<b>Model Loader (1)</b><br/>Load ONNX<br/>Pre-trained Model Path:<br/>/models/second_pretrained.onnx"]
    J["<b>Eval (1)</b><br/>Inference Testing<br/>Figure Output Path:<br/>/output/second_inference_results.png"]
