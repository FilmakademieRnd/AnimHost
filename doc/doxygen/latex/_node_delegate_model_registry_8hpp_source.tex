...
\hypertarget{_node_delegate_model_registry_8hpp_source}{}\label{_node_delegate_model_registry_8hpp_source}\index{C:/Users/m5963/Documents/GitHub/AnimHost/AnimHost/core/QTNodes/include/QtNodes/internal/NodeDelegateModelRegistry.hpp@{C:/Users/m5963/Documents/GitHub/AnimHost/AnimHost/core/QTNodes/include/QtNodes/internal/NodeDelegateModelRegistry.hpp}}
...
\DoxyCodeLine{00019\ }
\DoxyCodeLine{00021\ \textcolor{keyword}{class\ }NODE\_EDITOR\_PUBLIC\ NodeDelegateModelRegistry}
\DoxyCodeLine{00022\ \{}
...
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \ \ \ \ NodeDelegateModelRegistry()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00033\ \ \ \ \ \string~NodeDelegateModelRegistry()\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \ \ \ \ NodeDelegateModelRegistry(NodeDelegateModelRegistry\ \textcolor{keyword}{const}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00036\ \ \ \ \ NodeDelegateModelRegistry(NodeDelegateModelRegistry\ \&\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \ \ \ \ NodeDelegateModelRegistry\ \&operator=(NodeDelegateModelRegistry\ \textcolor{keyword}{const}\ \&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \ \ \ \ NodeDelegateModelRegistry\ \&operator=(NodeDelegateModelRegistry\ \&\&)\ =\ \textcolor{keywordflow}{default};}
\DoxyCodeLine{00041\ }
...
\DoxyCodeLine{00045\ \ \ \ \ \{}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ QString\ \textcolor{keyword}{const}\ name\ =\ computeName<ModelType>(HasStaticMethodName<ModelType>\{\},\ creator);}
...
\DoxyCodeLine{00107\ \ \ getTypeConverter(NodeDataType\ \textcolor{keyword}{const}\&\ d1,}
\DoxyCodeLine{00108\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ NodeDataType\ \textcolor{keyword}{const}\&\ d2)\ \textcolor{keyword}{const};}
...
\DoxyCodeLine{00127\ \ \ \ \ \textcolor{keyword}{struct\ }HasStaticMethodName\ :\ std::false\_type}
\DoxyCodeLine{00128\ \ \ \ \ \{\};}
\DoxyCodeLine{00129\ }
\DoxyCodeLine{00130\ \ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00131\ \ \ \ \ \textcolor{keyword}{struct\ }HasStaticMethodName<}
...
\DoxyCodeLine{00150\ \ \ \ \ \textcolor{keyword}{struct\ }UnwrapUniquePtr}
\DoxyCodeLine{00151\ \ \ \ \ \{}
...
\DoxyCodeLine{00159\ \ \ \ \ \textcolor{keyword}{struct\ }UnwrapUniquePtr<std::unique\_ptr<T>>}
\DoxyCodeLine{00160\ \ \ \ \ \{}
...
\DoxyCodeLine{00168\ \ \ \ \ \textcolor{keyword}{using\ }compute\_model\_type\_t\ =\ \textcolor{keyword}{typename}\ UnwrapUniquePtr<CreatorResult>::type;}
\DoxyCodeLine{00169\ \};}
\DoxyCodeLine{00170\ }
