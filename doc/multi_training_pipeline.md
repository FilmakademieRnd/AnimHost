...
graph TD
    ...
    G["<b>Second Model Config</b><br/>PAE Epochs: 150<br/>GNN Epochs: 75"]
    H["<b>Second Model</b><br/>Submodule Path:<br/>/models/second_model/pytorch"]
    I["<b>Second Train</b><br/>Training Loop<br/>Model Output Path:<br/>/output/second_model.onnx<br/>Progress: 0%"]
    J["<b>Second Evaluation</b><br/>Model Testing<br/>Progress: 0%<br/>Figure Output Path:<br/>/output/second_eval_results.png"]
