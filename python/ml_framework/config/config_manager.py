...
class ConfigManager:
    ...
    Provides static methods for loading and validating ML framework configurations
    from JSON files.
    """
    ...
    def load_config(config_name: str = "starke_model_config.json") -> StarkeModelConfig:
        ...
        Loads configuration from JSON file, validates its structure and contents,
        and returns a validated StarkeModelConfig object.
