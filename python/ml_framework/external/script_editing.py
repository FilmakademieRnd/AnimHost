...
def read_script_variable(script_path: Path, variable_name: str) -> Tuple[Optional[str], Optional[str]]:
    """
    Read a single variable from a script file.
    ...
    try:
        ...
        return read_script_variable_from_content(content, variable_name)
    except Exception as e:
        return None, f"Error reading script file: {e}"


def write_script_variable(script_path: Path, variable_name: str, value: Union[str, int, float, bool]) -> Optional[str]:
    """
    Write a single variable to a script file.
    ...
    try:
        ...
        modified_content, error = write_script_variable_to_content(content, variable_name, value)
        if error:
            return error
        ...
        return f"Error writing script variable: {e}"
