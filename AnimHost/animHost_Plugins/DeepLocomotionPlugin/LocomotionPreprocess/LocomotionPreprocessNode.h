#ifndef LOCOMOTIONPREPROCESS_H
#define LOCOMOTIONPREPROCESS_H
...
public:
    LocomotionPreprocessNode();
    ~LocomotionPreprocessNode();
    
    std::unique_ptr<NodeDelegateModel> Init() override { return  std::unique_ptr<LocomotionPreprocessNode>(new LocomotionPreprocessNode()); };

    static QString Name() { return QString("LocomotionPreprocessNode"); }
